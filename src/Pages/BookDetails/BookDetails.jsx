  ...
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-10">
            {/* Title & Author Header */}
            <header
              className="border-b pb-4 border-gray-100 animate-fadeInUp"
            ...
            <div
              className="p-6 bg-white rounded-xl border border-gray-200 shadow-md animate-fadeInUp"
              style={{ animationDelay: "600ms" }}
            >
              <h3 className="text-xl font-bold text-gray-800 mb-4 flex items-center">
                <FaBook className="mr-2" style={{ color: accentColor }} /> Key
                Publication Details
              </h3>
      ...
      <OrderNowModal
        ...
        bookPrice={price}
        bookId={_id} // ⭐ NEW: Pass the MongoDB book ID
        bookTitle={bookTitle} // ⭐ NEW: Pass the book title
      />
