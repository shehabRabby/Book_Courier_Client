        ...
        <div className="p-4 sm:p-8 bg-base-200 min-h-screen text-base-content">
            <header className="text-center mb-10">
                <h1 className="text-4xl font-black flex items-center justify-center text-base-content italic tracking-tight">
                    <FaFileInvoiceDollar className="mr-3 text-[#6366f1]" /> Payment Invoices
                </h1>
                    ...
                    <table className="table w-full border-collapse">
                        <thead>
                            <tr className="bg-base-200/50 border-b border-base-300">
                                <th className="py-5 text-[#6366f1] font-bold uppercase text-xs tracking-wider">Book Title</th>
                                <th className="py-5 text-[#6366f1] font-bold uppercase text-xs tracking-wider">Amount</th>
                                <th className="py-5 text-[#6366f1] font-bold uppercase text-xs tracking-wider">Date & Time</th>
                                <th className="py-5 text-[#6366f1] font-bold uppercase text-xs tracking-wider">Payment ID</th>
                            </tr>
                        </thead>
