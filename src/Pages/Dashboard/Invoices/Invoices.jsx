...
const Invoices = () => {
  ...
  return (
    ...
    <div className="p-4 sm:p-8 bg-base-200 min-h-screen text-base-content">
      ...
      {invoices.length === 0 ? (
        // 🎨 CHANGE: bg-base-100 for card consistency
        ...
        // 🎨 CHANGE: DaisyUI table class with base-100 background
        <div className="overflow-x-auto shadow-2xl rounded-xl border border-base-300 bg-base-100">
          <table className="table w-full">
            {/* 🎨 CHANGE: Table head uses base-300 for subtle contrast */}
            ...
            <tbody className="divide-y divide-base-300">
              {invoices.map((invoice) => (
                // 🎨 CHANGE: hover effect now theme-friendly
                <tr
                  key={invoice._id}
                ...
                >
                  ...
                  {/* 🎨 CHANGE: Used text-success for green amount in both themes */}
