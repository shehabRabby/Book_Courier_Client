...
// Define links with their required role(s)
        ...
        <div className="flex h-screen bg-base-200 text-base-content">
            ...
            >
                ...
                <nav className="p-4 space-y-2">
                    {filteredLinks.map((link) => ( // Use filteredLinks here
                        <NavLink
                            key={link.path}
                            to={link.path}
            ...
            <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
                ...
                <div className="flex-1 overflow-y-auto p-4 md:p-6 lg:p-8">
                    <div className="max-w-7xl mx-auto">
                        {/* We don't need to pass the user context here since useAuth is global, but it's okay to keep if components rely on it */}
                        <Outlet context={{ user }} /> 
                    </div>
                </div>
            </main>
